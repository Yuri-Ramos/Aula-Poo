...
public class Lista1Exercicio2 {
	    ...
	    public static void main(String[] args) {
	     ...
	     // Pedindo a idade de 6 amigos e adicionando na variável soma.
	        for (int i = 0; i < 6; i++) {
	            System.out.println("Digite a idade do amigo " + (i+1));
	         // Está pedindo a entrada do usuário e armazenando na variável `age`.
	            int age = meuObj.nextInt();
	            // Está adicionando o valor de `age` ao valor de `sum` e armazenando o resultado em `sum`..
	            sum += age;
	        }
